...
const EmailSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Form richiesta per inviare dati al server 
    const options = {
      // uso il metodo POST perchè sto inviando dati al server
      method: "POST",
      // comunico al server che mi trovo JSON.
      headers: {
        "Content-Type": "application/json",
      },
      // Il body della richiesta è il data JSON creato in precedenza
      body: JSONdata,
    };
